...
public class StoreXML {
    ...
    public String store(String _file,Boolean _quarantine,Boolean _allowDataDeletion)  throws RemoteException
    {
        ...
        AxisAccessLogger.LogServiceAccess(_username, messageContext, "StoreXML", "Called");
        StringBuffer sb = new StringBuffer();
            ...
            try {
                ...
                logger.error("",e);
                AxisAccessLogger.LogServiceAccess(_username, messageContext,"StoreXML","Store Failed");
    ...
    public String store(String session_id,String _file,Boolean _quarantine,Boolean _allowDataDeletion)  throws RemoteException
    {
        ...
        AxisAccessLogger.LogServiceAccess(user.getUsername(), messageContext, "StoreXML", "Called");
        StringBuffer sb = new StringBuffer();
            ...
            try {
                ...
                if (vr.isValid())
                {
                	...
                	sb.append("Item Successfully Stored.");
                    logger.info("Item Successfully Stored.");	
                    AxisAccessLogger.LogServiceAccess(user.getUsername(), messageContext, "StoreXML",item.getProperName() + " Successfully Stored");
                }else
                {
                	throw new ValidationException(vr);
                }
                ...
                logger.error("",e);
                AxisAccessLogger.LogServiceAccess(user.getUsername(), messageContext, "StoreXML", "Store Failed");
                throw new RemoteException("",e);
            } catch (XFTInitException e) {
                logger.error("", e);
                AxisAccessLogger.LogServiceAccess(user.getUsername(), messageContext, "StoreXML", "Store Failed");
