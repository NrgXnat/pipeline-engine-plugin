...
public class Browse {
    ...
    public ArrayList search(String _dataType,Date _date) throws RemoteException
    {
        ...
        AxisAccessLogger.LogServiceAccess(_username, messageContext,"Browse",_dataType + " since " + _date);
    ...
    public ArrayList search(String session_id,String _dataType,Date _date) throws RemoteException
    {
        ...
        AxisAccessLogger.LogServiceAccess(user.getUsername(), messageContext, "Browse", _dataType + " since " + _date);
        ArrayList al = new ArrayList();
        try {
